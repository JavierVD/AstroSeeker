...
const ManagePost = ({ route, navigation }) => {
            ...
            <View>
                ...
                >
                    <View style={{ alignItems: 'center', padding: 22, margin: 5 }}>
                        ...
                        <Text style={{ alignItems: 'center', padding: 22, margin: 5 }}>HERE ARE THE DIFFERENT INSTRUCTIONS TO HANDLE THE APPLICATION</Text>
    ...
    const Update = async (key) => {
        ...
        navigation.navigate("Community", {id: key})
    }
                ...
                <Stack direcion="column" space={2}>
                    ...
                    <Stack direction="row" space={2} style={Estilo.Caratula2}>
                        <Stack style={{ width: 800 }} direction="row" space={2} style={Estilo.Caratula3}>
                            ...
                            <Button onPress={ (e)=>handleChangeUpdVal(item.Id)}>Update</Button>
                            <Button onPress={() => { Erease(item.Id, item.Tema) }}>Delete</Button>
        ...
        return (
            ...
            >
                <View style={Estilo.ModalProc}>
                    <Text style={{ alignItems: 'center', padding: 22, margin: 5 }}>before continuing...</Text>
                    <Text style={{ alignItems: 'center', padding: 22, margin: 5 }}>¿really want to continue?</Text>
                ...
                <Modal
                    ...
                    <View style={Estilo.ViewComent}>
                        ...
                        <Stack direction="row" space={2}>
                            ...
                            <Input value={Comentario} onChange={(e) => setComentario(e.target.value)} variant="rounded" mx="3" placeholder="Share your ideas c:" />

                            <Button onPress={() => Update(updateVal)}>Update</Button>
