    ...
    try {
      ...
      if (isConnected) {
        Dialog.show({
          ...
          title: 'Conected',
          textBody: 'It has connected to the MAC ' + MACDIR,
          button: 'close',
        })
  ...
  render() {
    ...
    return (
      <View style={{flex: 1}}>
        ...
        <TouchableOpacity style={{color:"#FFF", position: 'absolute',left: 160, bottom: 20,borderColor: '#FFF', borderWidth: 1, borderRadius: 90, height: 70, width: 70, alignItems: 'center', backgroundColor: '#000'}} onPress={()=> this.startDiscover()}><Text style={{top: 25}}>Refresh</Text></TouchableOpacity>
        </ImageBackground>
      </View>
    );
  }
